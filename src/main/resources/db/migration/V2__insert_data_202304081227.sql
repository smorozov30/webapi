...
INSERT INTO make (id, name) VALUES (1, 'Lada'), (2, 'VW'), (3, 'Toyota');
...
INSERT INTO make_model (make_id, model_id) VALUES (1, 1), (1, 2), (1, 3), (2, 4), (3, 5);

-- Заполнение таблицы "Автомобиль"
INSERT INTO car (id, make_id, model_id) VALUES (1, 1, 1), (2, 2, 4), (3, 3, 5);